...
course_108_2 <-list()
for(i in 1:7){
  course_108_2[[i]] <- import("109學年上學期課程.xlsx", which = i)
}
course_108_2 <- rbind(course_108_2[[1]],course_108_2[[2]],course_108_2[[3]],course_108_2[[4]],course_108_2[[5]],course_108_2[[6]],course_108_2[[7]])


course_109_1 <-list()
for(i in 1:7){
  course_109_1[[i]] <- import("108學年下學期課程.xlsx", which = i)
}
course_109_1 <- rbind(course_109_1[[1]],course_109_1[[2]],course_109_1[[3]],course_109_1[[4]],course_109_1[[5]],course_109_1[[6]],course_109_1[[7]])
```
